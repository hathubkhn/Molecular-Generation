...
def get_resume(cfg, model_kwargs):
    ...
    if cfg.model.type == 'discrete':
        model = DiscreteDenoisingDiffusion.load_from_checkpoint("/home/user03/GEN-BIO/lmtu/DiGress/ckpt/planar.ckpt")
    else:
...
def main(cfg: DictConfig):
    ...
    elif dataset_config["name"] in ['qm9', 'guacamol', 'moses', 'zinc20', 'ic50']:
